...
//RV32M Multiply Extension
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, \
    R(rd) = (((int64_t)*((int32_t *)&src1) * *((int32_t *)&src2)) >> 32);
    );
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulsu  , R, \
    //R(rd) = (((int64_t)*((int32_t *)&src1) * *((int32_t *)&src2)) >> 32);
    TODO();
    );
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulu   , R, \
    //R(rd) = (((int64_t)*((int32_t *)&src1) * *((int32_t *)&src2)) >> 32);
    TODO();
    );
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(rd) = *((uint32_t *)&src1) / *((uint32_t *)&src2));
